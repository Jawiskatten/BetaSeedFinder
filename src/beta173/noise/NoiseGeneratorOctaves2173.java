...
public class NoiseGeneratorOctaves2173 {
    ...
    /** Rebuilds all simplex octaves in place. */
    public void reseed(Random random) {
        for (int i = 0; i < this.b; i++) {
            this.a[i].reseed(random);
        }
    }
    ...
    public double[] aStrided(
        ...
        return this.aStrided(adouble, d0, d1, i, j, strideX, strideZ, d2, d3, d4, 0.5D);
    }
