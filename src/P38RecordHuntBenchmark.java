...
/** Times the actual persistent P38 production stream for Mega and record profiles. */
public final class P38RecordHuntBenchmark {
    private static final String[] PROFILES = {"mega", "record60", "record80"};
    private static final String[] NAMES = {"Mega 30k+", "Record 60k+", "World Record coarse700"};
    private static final int[] P20_MIN = {1, 3, 3};
    private static final int[] UPPER_MIN = {8, 19, 19};
    private static final int[] HIGH_MIN = {6, 12, 20};
    private static final int[] COARSE_MIN = {85, 95, 700};

    private P38RecordHuntBenchmark() { }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("P38 production record-hunt benchmark");
        System.out.println("  deterministic worlds: " + worlds);
        System.out.println("  regions/world:        " + GpuStage0Scout.CENTER_COUNT);
        System.out.println("  iterations:           " + iterations);
        System.out.println("  telemetry:            lean 16B/region with exact P19 double");
        System.out.println();
        System.out.printf("  %-25s %12s %12s %11s %11s %11s %11s%n",
        ...
        for (int profileIndex = 0; profileIndex < PROFILES.length; profileIndex++) {
            ...
            System.out.printf(Locale.US, "  %-25s %12.1f %+11.1f%% %11d %11d %11d %11d%n",
        ...
        System.out.println("Run P38RecordHuntValidation to see the bundled historical evidence contract.");
    }
