...
// Exact native translation of src/P19MonsterGate.java.
// Keep constants and branch order unchanged: this is the production Stage0.75 gate.
...
struct MonsterFeatures {
    int stage0FullY88 = 0;
    int stage0FullY96 = 0;
    int stage0FullY104 = 0;
    int stage0FullY112 = 0;

    int stage0Y88LargestCluster = 0;
    int stage0Y88Width = 0;
    int stage0Y88Depth = 0;
    bool stage0Y88TouchesBorder = false;

    int stage0Y96LargestCluster = 0;
    int stage0Y96Width = 0;
    int stage0Y96Depth = 0;
    bool stage0Y96TouchesBorder = false;
};

static constexpr double THRESHOLD = 4.02;
static constexpr double EPSILON = 1.0E-6;
static constexpr int TREE_COUNT = 16;

inline bool hasExtremeTopologySignal(const MonsterFeatures& p);

inline double tree0(int scout, const MonsterFeatures& p);
inline double tree1(int scout, const MonsterFeatures& p);
inline double tree2(int scout, const MonsterFeatures& p);
inline double tree3(int scout, const MonsterFeatures& p);
inline double tree4(int scout, const MonsterFeatures& p);
inline double tree5(int scout, const MonsterFeatures& p);
inline double tree6(int scout, const MonsterFeatures& p);
inline double tree7(int scout, const MonsterFeatures& p);
inline double tree8(int scout, const MonsterFeatures& p);
inline double tree9(int scout, const MonsterFeatures& p);
inline double tree10(int scout, const MonsterFeatures& p);
inline double tree11(int scout, const MonsterFeatures& p);
inline double tree12(int scout, const MonsterFeatures& p);
inline double tree13(int scout, const MonsterFeatures& p);
inline double tree14(int scout, const MonsterFeatures& p);
inline double tree15(int scout, const MonsterFeatures& p);

inline double score(int scout, const MonsterFeatures& p) {
    return (
            tree0(scout, p) +
            tree1(scout, p) +
            tree2(scout, p) +
...
inline bool passes(int scout, const MonsterFeatures& p) {
