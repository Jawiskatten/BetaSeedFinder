...
// Exact cached P30/P31 upper stage. P20 has already evaluated and persisted the
...
__global__ void stage0UpperCompact192Kernel(
    ...
    __shared__ CompactUpperScratch s;
