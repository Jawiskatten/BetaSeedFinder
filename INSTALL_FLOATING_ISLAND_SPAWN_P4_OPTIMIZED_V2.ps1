...
$files = @(
    ...
    @{ Remote='scripts/run-floating-island-spawn-p4-optimized-amd-v2.ps1'; Local='scripts\run-floating-island-spawn-p4-optimized-amd.ps1' },
...
Write-Host ''
Write-Host 'P4 optimized v2 installed. Compiling + running correctness self-tests...'
